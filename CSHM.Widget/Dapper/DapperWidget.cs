...
public class DapperWidget : IDapperWidget
{
    ...
    public DapperWidget()
    {
        var connectionStrings = new List<ConnectionStringViewModel>
        {
            new()
            {
                ServerName = "CSHMLogDB",
                ConnectionString = ConfigWidget.GetConfigValue<string>("ConnectionStrings:CSHMLogDBConnectionString")
            },
            new()
            {
                ServerName = "CSHMDB",
                ConnectionString = ConfigWidget.GetConfigValue<string>("ConnectionStrings:CSHMDBConnectionString")
            },
             new()
            {
                ServerName = "WalletMidwareDB",
                ConnectionString = ConfigWidget.GetConfigValue<string>("ConnectionStrings:WalletMidwareDBConnectionString")
            },
