...
namespace CSHM.Data.Migrations
{
    ...
    [Migration("20250222093525_mig-14031204-02")]
    partial class mig1403120402
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CSHM.Domain.ChannelType", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TicketumSectionTypeID")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ChannelTypes", (string)null);
                });
            ...
            modelBuilder.Entity("CSHM.Domain.GenreType", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("GenreTypes", (string)null);
                });
            ...
            modelBuilder.Entity("CSHM.Domain.Notification", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CSHM.Domain.NotificationDraft", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("NotificationDrafts", (string)null);
                });

            modelBuilder.Entity("CSHM.Domain.NotificationOwner", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SeenDateTime")
                        .HasMaxLength(21)
                    ...
                    b.ToTable("NotificationOwners", (string)null);
                });

            modelBuilder.Entity("CSHM.Domain.NotificationType", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CSHM.Domain.ProductGenreType", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProductGenreTypes", (string)null);
                });
            ...
            modelBuilder.Entity("CSHM.Domain.ProductPropertyType", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProductPropertyTypes", (string)null);
                });
            ...
            modelBuilder.Entity("CSHM.Domain.PropertyType", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CSHM.Domain.Notification", b =>
                {
                    b.HasOne("CSHM.Domain.User", "Creator")
                        .WithMany()
                        .HasForeignKey("CreatorID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CSHM.Domain.NotificationType", "NotificationType")
                        .WithMany()
            ...
            modelBuilder.Entity("CSHM.Domain.NotificationOwner", b =>
                {
                    b.HasOne("CSHM.Domain.Notification", "Notification")
            ...
            modelBuilder.Entity("CSHM.Domain.Page", b =>
                {
                    b.HasOne("CSHM.Domain.ChannelType", "ChannelType")
                        .WithMany()
            ...
            modelBuilder.Entity("CSHM.Domain.ProductGenreType", b =>
                {
                    b.HasOne("CSHM.Domain.GenreType", "GenreType")
                        .WithMany()
            ...
            modelBuilder.Entity("CSHM.Domain.ProductPropertyType", b =>
                {
                    ...
                    b.HasOne("CSHM.Domain.PropertyType", "PropertyType")
                        .WithMany()
            ...
            modelBuilder.Entity("CSHM.Domain.Notification", b =>
                {
                    b.Navigation("NotificationOwners");
                });
