...
{
    public class ProductTypeService : Repository<ProductType, ProductTypeViewModel>, IProductTypeService
    {
        private readonly ILogWidget _log;
        private readonly IMapper _mapper;

        public ProductTypeService(DatabaseContext context, ILogWidget log, IMapper mapper) : base(context, log, mapper)
        {
            _log = log;
            _mapper = mapper;
        }

        public override ResultViewModel<ProductTypeViewModel> SelectAll(bool? activate, string filter = null, int? pageNumber = null, int pageSize = 20)
        {
            throw new NotImplementedException();
        }

        public List<ErrorViewModel> ValidationForm(ProductTypeViewModel entity)
        {
